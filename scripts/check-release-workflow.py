...
REQUIRED_SNIPPETS = {
    ...
    "release preflight PR read permission": "pull-requests: read",
    ...
    "release PR signoff preflight": "scripts/check-release-pr-signoff.py",
    "release PR signoff token": "GH_TOKEN: ${{ github.token }}",
    ...
    "GitHub release config tests": "scripts/test-github-release-config.py",
